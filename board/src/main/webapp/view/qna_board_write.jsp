		...
		<form action="/insert.do" method="post" role="form" id="writeForm" enctype="multipart/form-data">
			<div class="box-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea name="content" id="content" cols="60"
							class="form-control" rows="15" required="required"></textarea>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="password" name="password" id="password"
							class="form-control" size="10" maxlength="10" required="required" />
					</div>
				</div>
				<div class="form-group row">
					<label for="file" class="col-sm-2 col-form-label">파일첨부</label>
					<div class="col-sm-10">
						<input type="file" name="attach" id="file" /> <small
							class="text-muted" id="file">(파일크기 : 2MB)</small>
					</div>
				</div>
				<div style="height: 20px"></div>
				<div class="form-group text-center">
					...
					<button type="button" class="btn btn-warning" id="list" onclick="location.href='/view/qna_board_list.jsp'">
						목록보기</button>
				</div>
				<div style="height: 20px"></div>
			</div>
